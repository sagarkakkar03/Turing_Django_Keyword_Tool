...
if USE_SQLITE:
    ...
    # Use Postgres configuration from environment. Make SSL options optional.
    db_options = {}
    db_ssl_cert = env('DB_SSL_CERT', default=None)
    if db_ssl_cert:
        db_options = {
            'sslmode': 'require',
            'sslrootcert': os.path.join(BASE_DIR, db_ssl_cert),
        }
